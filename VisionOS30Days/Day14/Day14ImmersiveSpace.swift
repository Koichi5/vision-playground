...
struct Day14ImmersiveSpace: View {
    
    @State private var imageName: String
    @State var textureResource: AnyCancellable?
    ...
    var body: some View {
        RealityView { content in
            ...
            textureResource = TextureResource.loadAsync(named: imageName).sink { (error) in
                print(error)
